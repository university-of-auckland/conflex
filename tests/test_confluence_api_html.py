...
class TestConfluenceAPIWebPageCrawlingLists(unittest.TestCase):
    ...
    def test_basic_list(self):
        ...
        lst = self.confluence._ConfluenceAPI__handle_html_information(html_doc.read(), 'basic_list')
        html_doc.close()
    ...
    def test_embedded_list(self):
        ...
        lst = self.confluence._ConfluenceAPI__handle_html_information(html_doc.read(), 'embedded_list')
        html_doc.close()
    ...
    def test_multiple_list(self):
        ...
        lst = self.confluence._ConfluenceAPI__handle_html_information(html_doc.read(), 'multiple_list')
        html_doc.close()
    ...
    def test_wiki_example_list(self):
        ...
        lst = self.confluence._ConfluenceAPI__handle_html_information(html_doc.read(), 'wiki_example_list')
        html_doc.close()
...
class TestConfluenceAPIWebPageCrawlingTables(unittest.TestCase):
    ...
    def test_basic_table_horizontal_headings(self):
        ...
        lst = self.confluence._ConfluenceAPI__handle_html_information(html_doc.read(), 'horizontal_headings')
        html_doc.close()
    ...
    def test_basic_table_vertical_headings(self):
        ...
        lst = self.confluence._ConfluenceAPI__handle_html_information(html_doc.read(), 'vertical_headings')
        html_doc.close()
    ...
    def test_wiki_example_table(self):
        ...
        lst = self.confluence._ConfluenceAPI__handle_html_information(html_doc.read(), 'wiki_example')
        html_doc.close()
